...
This is a developement version of the R package HYRISK based on [Guyonnet et al., 2003](https://doi.org/10.1061/(ASCE)0733-9372(2003)129:1(68)) and [Baudrit et al., 2007](https://doi.org/10.1016/j.ijar.2006.07.001). In the following, you will find the details to use the package with a step-by-step example of a dyke stability analysis by [Ferson and Tucker 2006](https://doi.org/10.2172/886899). A user-friendly vignette is also available [here](https://github.com/rohmerj/HYRISK-vignette/blob/main/hyrisk_introduction.pdf). A full video tutorial is also available on the EGU platform [here](https://meetingorganizer.copernicus.org/EGU21/session/38918) - you will need to have a Copernicus account.

'Note' that the package is currently under reformating within the ANR project [HOUSES](https://anrhouses.github.io/). A new version will be released by 2026. 
